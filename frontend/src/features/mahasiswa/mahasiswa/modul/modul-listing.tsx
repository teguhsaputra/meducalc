...
export const columns: ColumnDef<TModulHasilPenilaian>[] = [
  ...
  {
    accessorKey: "kelompok_nomor",
    header: "Kelompok",
    cell: ({ row }) => (
      <div className="lowercase">{row.getValue("kelompok_nomor")}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const namaModul = row.getValue("nama_modul");

      return (
        <div className="flex justify-center gap-4">
          <Link href={`/mahasiswa/hasil-penilaian/${namaModul}/${nim}`}>
...
export function ModulMahasiswaListing({
  data,
  currentPage,
  totalPages,
  totalItems,
