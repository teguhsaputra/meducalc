      ...
      <div className="flex justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm font-bold">{data?.data.kelompok_nomor}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-sm">Nilai Akhir Modul</span>
            <span className="text-sm font-bold">{data?.data.nilaiAkhir?.nilai}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-sm">Tingkat</span>
            <span className="text-sm font-bold">{data?.data.nilaiAkhir?.tingkat}</span>
          </div>
        </div>
      </div>
