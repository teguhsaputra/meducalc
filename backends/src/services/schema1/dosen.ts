...
class DosenServices {
  ...
  static async getModulDosenDetailHasilPenilaian(
    ...
    try {
      ...
      if (!modul) {
        throw new Error(
          `Modul dengan nama "${trimmedNamaModul}" tidak ditemukan`
        );
      }
  ...
  static async getModulDosenHasilInputPenilaian(
    userId: number,
    role: string,
    namaModul: string,
    nim: string
  ...
  static async getModulDosenByNimPeserta(
    userId: number,
    role: string,
    namaModul: string,
    nim: string
  ...
  static async modulDosenInputPenilaian(
    userId: number,
    role: string,
    nim: string,
    namaModul: string,
