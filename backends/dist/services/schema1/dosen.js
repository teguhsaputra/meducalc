...
class DosenServices {
    ...
    static addDosen(userId, userRole, namaDepan, tanggalLahir, username, password, role) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    static getModulDosenDetailHasilPenilaian(userId_1, role_1, namaModul_1) {
        return __awaiter(this, arguments, void 0, function* (userId, role, namaModul, page = 1, limit = 10, searchSiswa = "", searchNim = "", sortOrder = "asc") {
            try {
                let dosenName = null;
                let prismaClient;
                // Validasi role dan ambil nama dosen
    ...
    static getModulDosenHasilInputPenilaian(userId, role, namaModul, nim) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static getModulDosenDetailForInputPenilaian(userId_1, role_1, namaModul_1) {
    ...
    static modulDosenInputPenilaian(userId, role, nim, namaModul, input) {
        return __awaiter(this, void 0, void 0, function* () {
